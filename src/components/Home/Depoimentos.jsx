        ...
        <section className='mb-5 pb-5' >
            <div className='container-sm'>
                ...
                <div className='mb-4'>
                  ...
                  {/* MOBILE CAROUSEL */}
                  <div className='carousel slide w-100 d-lg-none mb-4'  
                   ...
                   <div className='carousel-inner'>
                        ...
                        <div className="carousel-item active" data-bs-interval='10000' >
                                <div className="position-relative">
                                        <div style={{fontStyle:'italic', height:'200px'}} className='txt-comment border border-3 rounded-3 p-4 overflow-y-auto' >
                                            <p>"Desde a arquitetura, a limpeza, a decoração, o lago maravilhoso que fica em frente à pousada com stand up e boia para você aproveitar...até o café da manhã...e principalmente o carinho do Thiago, que é o dono. A estadia foi maravilhosa e contribuiu para que nossas férias e nossa experiência em Capitólio fosse inesquecível".</p>
                                            <img src={Commas} alt="img" className='position-absolute w-25 h-50 top-0 start-0 m-4 opacity-25' />
                                        </div>
                        ...
                        <div className="carousel-item" data-bs-interval='10000' >
                                <div className="position-relative">
                                    <div style={{fontStyle:'italic', height:'200px'}} className='txt-comment border border-3 rounded-3 p-4 overflow-y-auto' >
                                        <p>"O local é muito aconchegante, o quarto é ótimo, tem ventilador de teto e ar condicionado , a cama éconfortável o chuveiro é sensacional, ... o dono do local Tiago é muito atencioso , deu suporte o tempo todo , indicou passeios ... Sem dúvidas se voltarmos a Capitólio ficaremos aqui..."</p>
                                        <img src={Commas} alt="img" className='position-absolute w-25 h-50 top-0 start-0 m-4 opacity-25' />
                                    </div>
                        ...
                        <div className="carousel-item active" data-bs-interval='10000' >
                            <div className="row">
                                ...
                                <div className="col-6 position-relative">
                                        <div style={{fontStyle:'italic', height:'175px'}} className='txt-comment border border-3 rounded-3 p-4 overflow-y-auto' >
                                            <p>"Desde a arquitetura, a limpeza, a decoração, o lago maravilhoso que fica em frente à pousada com stand up e boia para você aproveitar...até o café da manhã...e principalmente o carinho do Thiago, que é o dono. A estadia foi maravilhosa e contribuiu para que nossas férias e nossa experiência em Capitólio fosse inesquecível".</p>
                                            <img src={Commas} alt="img" className='position-absolute w-25 h-50 top-0 start-0 m-4 opacity-25' />
                                        </div>
                                        <h6 className='text-end mt-1' > Ingrid </h6>
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="model-footer text-end p-2 ">
                                    <button style={{backgroundColor:'grey'}} className='btn text-white fw-bolder shadow-sm' data-bs-dismiss='modal' > Fechar </button>
                                </div>
