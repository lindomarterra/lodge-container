        ...
        <section className='mb-5 pb-5' >
            ...
            <div className='container-sm'>
                ...
                <div className='carousel slide d-sm-none'
                        ...
                        <div className="row">
                            ...
                            <div className="col-12">
                                <div className="d-flex flex-column text-center border border-1 border-blck-50">
                                    ...
                                    <p className='truncar-3l text-black-50 p-2'>
                                    Térreo, cama de casal, beliche, ar condicionado, ventilador de teto, wi-fi, banheiro privativo.<br/>
                    ...
                    <button type='button' className='carousel-control-prev' data-bs-target='#slide-acomodacoes-mobile' data-bs-slide='prev'>
                    <span className='carousel-control-prev-icon' aria-hidden='true' ></span>
                    <span className='visually-hidden'>Prev</span>
                    </button>
                    <button type='button' className='carousel-control-next' data-bs-target='#slide-acomodacoes-mobile' data-bs-slide='next'>
                    ...
                    {/* TABLET  CAROUSEL*/}                    
                <div className='carousel slide carousel-dark d-none d-sm-block d-lg-none '
                    data-bs-ride="carousel" id='slide-acomodacoes-tabled' >
                ...
                <div className="carousel-item">
                    ...
                    <div className='pt-5'>
                        <div className="carousel-indicators "  >
                                <button type="button" data-bs-target="#slide-acomodacoes-tabled" data-bs-slide-to="0" className="active bg-black-50"></button>
                                <button type="button" data-bs-target="#slide-acomodacoes-tabled" data-bs-slide-to="1" className='bg-black-50' ></button>
                                <button type="button" data-bs-target="#slide-acomodacoes-tabled" data-bs-slide-to="2" className='bg-black-50' ></button>
                                <button type="button" data-bs-target="#slide-acomodacoes-tabled" data-bs-slide-to="3" className='bg-black-50' ></button>
                   ...
                   {/* DESKTOP CAROUSEL */}
                    <div className='carousel slide carousel-dark d-none w-100 d-lg-block '
                        data-bs-ride="carousel" id='slide-acomodacoes' >
                    ...
                    <div className='pt-5'>
                        <div className="carousel-indicators "  >
                            <button type="button" data-bs-target="#slide-acomodacoes" data-bs-slide-to="0" className="active bg-black-50"></button>
                            <button type="button" data-bs-target="#slide-acomodacoes" data-bs-slide-to="1" className='bg-black-50' ></button>
                            <button type="button" data-bs-target="#slide-acomodacoes" data-bs-slide-to="2" className='bg-black-50' ></button>
